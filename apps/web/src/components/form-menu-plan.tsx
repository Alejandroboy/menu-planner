...
import { useCreateOrUpdateMenuPlan } from '@/api/use-create-or-update-menu-plan.hook';
import { MutationType } from '@/api/types';

export const FormMenuPlan = ({
  ...
  const mutation = useCreateOrUpdateMenuPlan(type, menuPlanId);
